...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		Integer projectDelete = getIntInput("Enter the ID of the project to delete");
		
		projectService.deleteProject(projectDelete);
		
		System.out.println("The project with ID " + projectDelete + " has been deleted from the database");
		
		if(Objects.nonNull(curProject) && curProject.getProjectId().equals(projectDelete)) {
			curProject = null;
		}
	}
	private void updateProjectDetails() {
		if(Objects.isNull(curProject)) {
			System.out.println("Please select a project to update");
			return;
		}
		...
		project.setActualHours(Objects.isNull(actualHours) ? curProject.getEstimatedHours() : actualHours);
